<template>
  ...
  >
    ...
    >
      <li
        v-for="item in items"
        class="lg:py-[26px] xsm:px-0 text-gray-400 hover:text-primary duration-300 cursor-pointer header-link text-center"
      >
      ...
      <li
        class="lg:py-[26px] xsm:px-0 text-gray-400 hover:text-primary duration-300 cursor-pointer header-link lg:hidden xsm:block text-center"
      >
    ...
    >
      <span
        class="w-full h-[1px] bg-[#0f0f0f] block duration-300"
